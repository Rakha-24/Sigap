...
<section id="sigap-admin-users-edit" class="sigap-page">
    ...
    <div class="sigap-card max-w-2xl">
        <form method="POST" action="{{ route('admin.users.update', $user) }}" id="sigap-admin-users-edit__form" class="sigap-form max-w-none">
            @csrf
            @method('PUT')
            ...
            <div class="flex gap-3 flex-wrap">
                <button type="submit" class="sigap-form__submit sm:!w-auto sm:px-8">Perbarui Pengguna</button>
