...
<section id="sigap-admin-master-data-kategori-edit" class="sigap-page">
    ...
    <form method="POST" action="{{ route('admin.master-data.kategori.update', $kategori) }}" class="sigap-form" id="sigap-admin-master-data-kategori-edit__form">
        @csrf
        @method('PUT')
        ...
        <button type="submit" class="sigap-form__submit">Perbarui Kategori</button>
    </form>
</section>
@endsection