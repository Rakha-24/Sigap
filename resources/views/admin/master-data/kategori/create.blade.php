    ...
    <div class="sigap-page__header">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="sigap-page__subtitle">Tambahkan kategori baru beserta SLA default-nya.</p>
            </div>
        </div>
    </div>

    <div class="sigap-card max-w-2xl">
        <form method="POST" action="{{ route('admin.master-data.kategori.store') }}" class="sigap-form max-w-none" id="sigap-admin-master-data-kategori-create__form">
            @csrf
            ...
            <div class="flex gap-3 flex-wrap">
                <button type="submit" class="sigap-form__submit sm:!w-auto sm:px-8">Simpan Kategori</button>
