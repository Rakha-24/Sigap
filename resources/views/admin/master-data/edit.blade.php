    ...
    <div class="sigap-page__header">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="sigap-page__subtitle">Perbarui informasi departemen.</p>
            </div>
        </div>
    </div>

    <div class="sigap-card max-w-2xl">
        <form method="POST" action="{{ route('admin.master-data.departemen.update', $departemen) }}" class="sigap-form max-w-none" id="sigap-admin-master-data-edit__form">
            @csrf
            @method('PUT')
            ...
            <div class="flex gap-3 flex-wrap">
                <button type="submit" class="sigap-form__submit sm:!w-auto sm:px-8">Perbarui Departemen</button>
